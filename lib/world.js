...
World.prototype.click = function(id){
    return this.find(id)
        .then(el => this.whenVisible(el).then(el => el.click()));
};

World.prototype.sendKeys = function(id, text){
    return this.find(id)
        .then(el => this.whenVisible(el).then(el => el.sendKeys(text)));
};

World.prototype.getText = function(id){
    return this.find(id)
        .then(el => this.whenVisible(el).then(el => el.getText()));
};

World.prototype.getVal = function(id){
    return this.find(id)
        .then(el => this.whenVisible(el).then(el => el.getAttribute('value')));
};
